...
const onDelete = async () => {
  try {
    await onApiDelete(`/admin/environmental/delete/${activeDeleteId.value}`)
    reFetch()
...
<template>
  <div class="mt-4">
    <DataTable :loading="loading" :data="environmental?.environmental || []" :fields="fields">
