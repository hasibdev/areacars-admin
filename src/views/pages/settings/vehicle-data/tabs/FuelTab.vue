...
<template>
  <div class="mt-4">
    <DataTable :loading="loading" :data="fuels?.fuels || []" :fields="fields">
  ...
  <!-- Entfernen Modal -->
  <ConfirmDialog v-model="showDeleteModal" @onOk="onDelete" :okLoading="deleting" title="Kraftstoff löschen" message="Möchten Sie diesen Kraftstoff wirklich entfernen?"></ConfirmDialog>
</template>
