...
<template>
  <div class="mt-4">
    <DataTable :loading="loading" :data="accidents?.accidents || []" :fields="fields">
  ...
  <!-- Entfernen Modal -->
  <ConfirmDialog v-model="showDeleteModal" @onOk="onDelete" :okLoading="deleting" title="Entfernen Fahrzeug" message="Sind Sie sicher, dass Sie dies entfernen möchten Fahrzeug?"></ConfirmDialog>
</template>
