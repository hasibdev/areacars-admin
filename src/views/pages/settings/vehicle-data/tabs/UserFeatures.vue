...
const onDelete = async () => {
  try {
    await onApiDelete(`/admin/userfeature/delete/${activeDeleteId.value}`)
    reFetch()
...
<template>
  ...
  <!-- Entfernen Modal -->
  <ConfirmDialog v-model="showDeleteModal" @onOk="onDelete" :okLoading="deleting" title="Benutzerdefiniertes Merkmal löschen" message="Möchten Sie dieses Merkmal wirklich entfernen?"></ConfirmDialog>
</template>
