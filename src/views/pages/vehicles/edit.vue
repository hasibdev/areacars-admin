...
watch(data, (updatedData) => {
  if (updatedData?.car_images) {
    const newImages = updatedData.car_images?.map(img => ({ ...img, dId: img.carim_id }))
  ...
  if (updatedData?.carinfo) {
    const newObj = {
      ...
      vat_deductible: Boolean(Number(updatedData.carinfo.vat_deductible)),
      negotiation_price: Boolean(Number(updatedData.carinfo.negotiation_price)),
      genral_inspection_new: Boolean(Number(updatedData.carinfo.genral_inspection_new)),
      emission_inspection_new: Boolean(Number(updatedData.carinfo.emission_inspection_new)),

      full_service_history: Boolean(Number(updatedData.carinfo.full_service_history)),
      non_smoker: Boolean(Number(updatedData.carinfo.non_smoker)),
      accident_free: Boolean(Number(updatedData.carinfo.accident_free)),
      used_car_warranty: Boolean(Number(updatedData.carinfo.used_car_warranty)),
      dekra_seal: Boolean(Number(updatedData.carinfo.dekra_seal)),
      export_vehicle: Boolean(Number(updatedData.carinfo.export_vehicle)),

      metallic: Boolean(Number(updatedData.carinfo.metallic)),
    }
...
const saveForm = async () => {
  ...
  try {
    ...
    await api.post(`/admin/productupload/update/${route.params.id}`, payload)
    ...
    <div class="borderd-content">
      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-xxl-5 offset-xxl-1">
          ...
          <ImageUploader v-model="files" :uniqueId="uniqueId" :previousImages="previousImages" errorField="defaulatimage" />
    ...
    <div class="borderd-content mt-4">
      ...
      <div class="row">
        <div class="col-lg-6 col-xxl-6">
          ...
          <InputControl v-model="form.engine_capacity" :label="`${t('field.engineCapacity')}:`" type="number" class="mt-3" errorField="engine_capacity" />
    ...
    <div class="borderd-content mt-4">
      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-xxl-6">
          ...
          <InputControl replaceCommaOnBlur v-model="form.city_fuel_efficiency" :label="`${t('field.cityFuelEfficiency')}:`" class="mt-3" errorField="city_fuel_efficiency" />
        </div>

        <div class="col-lg-6 col-xxl-5 offset-xxl-1">
          <div class="empty-space"></div>
          <InputControl replaceCommaOnBlur v-model="form.highway_fuel_efficiency" :label="`${t('field.highwayFuelEfficiency')}:`" class="mt-3" errorField="highway_fuel_efficiency" />
        </div>
        <div class="col-lg-6 col-xxl-6">
          <InputControl replaceCommaOnBlur v-model="form.combined" :label="`${t('field.combined')}:`" class="mt-3" errorField="combined" />
        </div>
        <div class="col-lg-6 col-xxl-5 offset-xxl-1">
          <InputControl replaceCommaOnBlur v-model="form.co2_emissio" :label="`${t('field.CO2Emission')}:`" class="mt-3" errorField="co2_emissio" />
        </div>
    ...
    <div class="borderd-content mt-4">
      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-xxl-5 offset-xxl-1">
          ...
          <CalenderControl v-model="form.available_from_date" label="Verfügbar ab (im Vorlauf):" class="mt-4" errorField="available_from_date" />
        </div>
      </div>
    </div>
