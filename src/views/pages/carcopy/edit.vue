...
const saveForm = async () => {
  try {
    ...
    await api.post(`/admin/productupload/carcopyupdate/${route.params.id}`, payload)
    ...
    <div class="borderd-content">
      ...
      <div class="row">
        <div class="col-lg-6 col-xxl-6">
          ...
          <InputControl v-model="form.internal_number" :label="`${t('field.internalNumber')}:`" errorField="internal_number" class="mt-3" />
          ...
          <InputControl v-model.number="form.selling_price" :label="`${t('field.customerPrice')}:`" type="number" class="mt-3" errorField="customer_price" />
          ...
          <InputControl v-model.number="form.customer_price" :label="`${t('field.sellingPrice')}:`" type="number" class="mt-3" errorField="selling_price" />
        ...
        <div class="col-lg-6 col-xxl-5 offset-xxl-1">
          ...
          <ImageUploader carcopy v-model="files" :uniqueId="uniqueId" @onDeletecFilesImage="onDeletecFilesImage" :previousImages="previousImages" errorField="defaulatimage" />
