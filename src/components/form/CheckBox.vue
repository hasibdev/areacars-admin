...
<template>
  <div class="form-check">
    <input :checked="getChecked" @input="onChange" type="checkbox" :disabled="props.disabled" :id="props.id" class="form-check-input">
    <label v-if="props.label" class="form-check-label ms-3 label" :for="props.id" style="font-size: 14px;">
      {{ props.label }}
    </label>
  </div>
</template>
